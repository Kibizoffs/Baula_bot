...
not_in_group = F"{OSTANOV}у тебя нет группы. Присвой значение к 'gr' через /edit 🤓"
not_in_107_108 = f'{OSTANOV}ты не в 107-ой или 108-ой группе. Шуруй отсюда 😝'
...
trash_memory = 'Память:'
trash_text = 'Сборщик мусора {} обнаружила эту нечисть 😬'
